...
class MaintainabilityReview(BaseModel):
    concerns: list[str] = Field(description = "The concerns in the code", default = None)
...
def security_review(state: State):
    code = state["code"]
    messages = [
        ("system", "You are a security expert that reviews the code and indetifies the vulnerabilities."),
